...
bot = commands.Bot(command_prefix='p!', description="""A multi-purpose Discord Bot created by ThatNerdyPikachu""", owner_id=your id)
...
async def on_ready():
    ...
    await bot.change_presence(game=discord.Game(name="with pikas heartstrings ;-; | v1.1"))
    print("ready")
